...
const documents = {
    ...
    "query GetRecipes($ingredients: [String!], $limit: Int!) {\n  recipes(ingredients: $ingredients, first: $limit) {\n    edges {\n      cursor\n      node {\n        id\n        title\n        ratings\n        author\n        ingredients {\n          id\n          description\n        }\n        category {\n          name\n        }\n        image\n        createdAt\n        updatedAt\n      }\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n      hasPreviousPage\n      startCursor\n    }\n  }\n}": types.GetRecipesDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetRecipes($ingredients: [String!], $limit: Int!) {\n  recipes(ingredients: $ingredients, first: $limit) {\n    edges {\n      cursor\n      node {\n        id\n        title\n        ratings\n        author\n        ingredients {\n          id\n          description\n        }\n        category {\n          name\n        }\n        image\n        createdAt\n        updatedAt\n      }\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n      hasPreviousPage\n      startCursor\n    }\n  }\n}"): (typeof documents)["query GetRecipes($ingredients: [String!], $limit: Int!) {\n  recipes(ingredients: $ingredients, first: $limit) {\n    edges {\n      cursor\n      node {\n        id\n        title\n        ratings\n        author\n        ingredients {\n          id\n          description\n        }\n        category {\n          name\n        }\n        image\n        createdAt\n        updatedAt\n      }\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n      hasPreviousPage\n      startCursor\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
